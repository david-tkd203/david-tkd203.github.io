...
//#endregion
//#region assets/index-_hLRxObI.js
(function polyfill() {
	const relList = document.createElement("link").relList;
	if (relList && relList.supports && relList.supports("modulepreload")) return;
	for (const link of document.querySelectorAll("link[rel=\"modulepreload\"]")) processPreload(link);
...
function Contact() {
	...
	const [hoveredDetail, setHoveredDetail] = (0, import_react.useState)(null);
	...
	const contactDetails = [
		{
			icon: EmailIcon,
			label: "Email",
			value: "david.203.52@gmail.com",
			link: "mailto:david.203.52@gmail.com"
		},
		{
			icon: PhoneIcon,
			label: "Teléfono",
			value: "+569 9505 2746",
			link: "tel:+56995052746"
		},
		{
			icon: LocationIcon,
			label: "Ubicación",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					style: subtitleStyle,
					children: "¿Tienes un proyecto en mente? ¡Hablemos!"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						display: "grid",
					...
					children: contactDetails.map((detail, idx) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								detail.link ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									href: detail.link,
									style: {
										color: "#cccccc",
										textDecoration: "none",
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						"© ",
						currentYear,
						" David Nanculeo. Hecho con ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
								color: "#ff00ff",
								animation: "pulse 1.5s infinite"
							},
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FaHeart, { style: { display: "inline" } })
						}),
						" y mucha dedicación."
					]
				}),
